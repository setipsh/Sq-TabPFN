...
def train(priordataloader_class, criterion=None, encoder_generator, emsize=200, nhid=200, nlayers=6, nhead=2, dropout=0.0,
    ...
    encoder = encoder_generator(dl.masked_features, emsize)
    ...
    try:    
        for epoch in (range(1, epochs + 1) if epochs is not None else itertools.count(1)):
            ...
            accuracy ,total_loss, total_positional_losses, time_to_get_batch, forward_time, step_time, nan_share, ignore_share =\
                train_epoch()
